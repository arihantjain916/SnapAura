    ...
    <div
        ...
        <section style="max-width: 42rem; background-color: #fff;">
            ...
            <p style="color: #7b8794; padding-left: 1.25rem; padding-right: 1.25rem; margin-top: 2rem;">
                ...
                <a href="mailto:dummymail12hai@gmail.com" style="color: #365cce; text-decoration : none;"
                    alt="dummymail12hai@gmail.com" target="_blank">
                    dummymail12hai@gmail.com
                </a>
            ...
            <footer style="margin-top: 2rem;">
                <div
                    ...
                    <div style="text-align: center; display: flex; flex-direction: column; gap: 0.75rem;">
                        ...
                        <a href="tel:+91-9672670732" style="color: #4b5563;" alt="+91-9672670732">
                            +91-9672670732
                        </a>
                    ...
                    <div style="display: flex; align-items: center; justify-content: center; gap: 0.75rem;">
                        ...
                        <a href="#_">
                            <svg stroke="currentColor" fill="gray" stroke-width="0" viewBox="0 0 1024 1024" height="18"
                                width="18" xmlns="http://www.w3.org/2000/svg">
                                <path
                ...
                <div
                    ...
                    <p class="footertext">© 2024 SnapAura.</p>
                </div>
            </footer>
        </section>
    </div>
